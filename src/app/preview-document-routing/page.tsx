...
const ShopSection = ({
    ...
    return (
        <div style={{ marginBottom: "12px" }}>
            ...
            {/* Shop Focus & Q7B7 */}
            <div style={{ display: "flex", justifyContent: "space-between", fontSize: "10px", marginBottom: "6px", paddingLeft: "4px" }}>
                ...
                <div style={{ display: "flex", justifyContent: "center" }}>
                    ...
                    >
                        ...
                        {doc.shops.map((shop, idx) => (
                            <ShopSection key={idx} shop={shop} shopIndex={idx} totalAssetRows={9} />
                        ))}

...
const mockDocument = {
    ...
    transferType: "Event", // ประเภทการย้าย: Event, ส่งคืนผู้ผลิต, ส่งคืนโกดังเช่า, อื่นๆ
    shops: [
        {
            shopCode: "MCS001",
            ...
            shopFocus: "Focus A",
            assets: [
                { name: "Kiosk Y22 - Detachable Logo", size: '', grade: "A", kv: "", qty: 2, withdrawFor: "WH Bangkok" },
                { name: "Shelf Display B", size: '60x40cm', grade: "AB", kv: "", qty: 1, withdrawFor: "WH Chonburi" },
...
const CheckBox = ({ checked, label }: { checked: boolean; label: string }) => (
    <div style={{ display: "flex", alignItems: "center", gap: "6px", fontSize: "12px" }}>
        <div style={{
            ...
            {checked && (
                <span style={{ color: colors.white, fontSize: "12px", fontWeight: "bold", position: "relative", top: "-1px" }}>✓</span>
            )}
        </div>
        <span>{label}</span>
    </div>
...
export default function PreviewDocumentTransferPage() {
    ...
    // ประเภทการย้าย
    const transferTypes = ["Event", "ส่งคืนผู้ผลิต", "ส่งคืนโกดังเช่า", "อื่นๆ"];
                ...
                <div style={{ display: "flex", justifyContent: "center" }}>
                    ...
                    >
                        ...
                        <div style={{
                            ...
                            <div style={{ fontSize: "11px", fontWeight: 600, color: colors.secondary }}>ประเภทการย้าย:</div>
                            {transferTypes.map((type) => (
                                <CheckBox key={type} checked={doc.transferType === type} label={type} />
                            ))}
                        </div>
                        ...
                        <table style={{ width: "100%", borderCollapse: "collapse", marginBottom: "8px", borderRadius: "8px", overflow: "hidden" }}>
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th style={{ ...thStyle, width: "55px" }}><span style={{ position: "relative", top: textOffset }}>เกรด</span></th>
                            ...
                            <tbody>
                                {assets.map((asset, idx) => (
                                    <tr key={idx}>
                                        ...
                                        <Cell width="55px" center isAlt={idx % 2 === 1} hasImage>{asset.grade || "-"}</Cell>

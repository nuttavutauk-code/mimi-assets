...
import { Loader2, Search, ChevronLeft, ChevronRight, RefreshCw, Database, Filter } from "lucide-react";
...
export default function AdminDatabase() {
  ...
  const renderCellValue = (item: TransactionData, columnName: string) => {
